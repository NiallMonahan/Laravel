    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('events.map')" :active="request()->routeIs('events.map')"
                        class="text-gray-300 hover:text-pink-400 border-b-2 border-transparent hover:border-pink-400 {{ request()->routeIs('events.map') ? 'text-pink-500 border-pink-500 font-semibold' : '' }}">
                        {{ __('Events Map') }}
                    </x-nav-link>
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-gray-900 border-t border-gray-800">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('events.map')" :active="request()->routeIs('events.map')"
                    class="block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-gray-300 hover:text-pink-400 hover:bg-gray-800 hover:border-pink-400 {{ request()->routeIs('events.map') ? 'text-pink-500 border-pink-500 font-semibold bg-gray-800' : '' }}">
                    {{ __('Events Map') }}
                </x-responsive-nav-link>
